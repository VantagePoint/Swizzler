...
struct ACalendarRecord {
    CDUnknownFunctionPointerType *_vptr$AGoodRecord;
...
struct AnAttachment {
    CDUnknownFunctionPointerType *_vptr$AnAttachment;
...
struct GxFile {
    CDUnknownFunctionPointerType *_vptr$GxFile;
...
struct GxString {
    CDUnknownFunctionPointerType *_vptr$GxStringMemoryEraser;
    int *m_s;
    unsigned int m_len;
...
struct gdPairingsTable {
    CDUnknownFunctionPointerType *_vptr$ASQLBroadcaster;
...
struct vector<ASBBookmarkRecord *, std::allocator<ASBBookmarkRecord *>> {
    struct _Vector_impl {
        struct ASBBookmarkRecord **_M_start;
        struct ASBBookmarkRecord **_M_finish;
        struct ASBBookmarkRecord **_M_end_of_storage;
    } _M_impl;
};

struct vector<SBCookieRecord *, std::allocator<SBCookieRecord *>> {
    struct _Vector_impl {
        struct SBCookieRecord **_M_start;
        struct SBCookieRecord **_M_finish;
        struct SBCookieRecord **_M_end_of_storage;
    } _field1;
};
...
typedef struct list<int, std::allocator<int>> {
    struct _List_impl _field1;
} list_3318791b;
...
typedef struct shared_ptr<EmailMarkingRecord> {
    struct EmailMarkingRecord *_field1;
    struct shared_count _field2;
} shared_ptr_a7f21a78;
...
typedef struct vector<ASBBookmarkRecord *, std::allocator<ASBBookmarkRecord *>> {
    struct _Vector_impl {
        struct ASBBookmarkRecord **_M_start;
        struct ASBBookmarkRecord **_M_finish;
        struct ASBBookmarkRecord **_M_end_of_storage;
...
typedef struct vector<SBCookieRecord *, std::allocator<SBCookieRecord *>> {
    struct _Vector_impl {
        struct SBCookieRecord **_M_start;
        struct SBCookieRecord **_M_finish;
        struct SBCookieRecord **_M_end_of_storage;
