...
@interface KLAppointmentLocationController : GUFontSizeAwareViewController <UITextFieldDelegate>
{
...
@property(retain, nonatomic) UITextField *textFieldLocation; // @synthesize textFieldLocation;
