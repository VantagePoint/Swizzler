...
@interface SBOfflineCaptureMgr : NSObject <SBResourceLoaderDelegate>
{
    BOOL _enabled;
    NSString *_basePath;
}
...
- (BOOL)cleanup;
- (BOOL)checkHostPathWithUrl:(id)arg1 createPath:(BOOL)arg2;
- (id)filePathForUrl:(id)arg1 mimeType:(id)arg2;
- (id)fileDirPathForUrl:(id)arg1;
- (void)dealloc;
