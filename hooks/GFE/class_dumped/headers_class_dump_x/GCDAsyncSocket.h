...
@interface GCDAsyncSocket : _ABAddressBookAddRecord
{
    unsigned int flags;
...
- (void)synchronouslySetDelegate:(id)fp8 delegateQueue:(struct dispatch_queue_s *)fp12;
- (void)setDelegate:(id)fp8 delegateQueue:(struct dispatch_queue_s *)fp12;
- (void)setDelegate:(id)fp8 delegateQueue:(struct dispatch_queue_s *)fp12 synchronously:(BOOL)fp16;
- (void)getDelegate:(id *)fp8 delegateQueue:(struct dispatch_queue_s **)fp12;
- (void)synchronouslySetDelegateQueue:(struct dispatch_queue_s *)fp8;
- (void)setDelegateQueue:(struct dispatch_queue_s *)fp8;
- (void)setDelegateQueue:(struct dispatch_queue_s *)fp8 synchronously:(BOOL)fp12;
- (struct dispatch_queue_s *)delegateQueue;
...
- (id)delegate;
- (void)dealloc;
- (id)initWithDelegate:(id)fp8 delegateQueue:(struct dispatch_queue_s *)fp12 socketQueue:(struct dispatch_queue_s *)fp16;
- (id)initWithDelegate:(id)fp8 delegateQueue:(struct dispatch_queue_s *)fp12;
- (id)initWithSocketQueue:(struct dispatch_queue_s *)fp8;
- (id)init;
