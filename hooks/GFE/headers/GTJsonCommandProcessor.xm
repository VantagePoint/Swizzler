...
{
	id ret = %orig;
	NSLog(@"GTJsonCommandProcessor parseJSONArray");
	return ret;
};
+ (id)parseJSONDictionary:(struct json_object *)arg1
{
	id ret = %orig;
	NSLog(@"GTJsonCommandProcessor parseJSONDictionary");
	return ret;
};
+ (id)parseNSData:(struct json_object *)arg1
{
	id ret = %orig;
	NSLog(@"GTJsonCommandProcessor parseNSData");
	return ret;
};
