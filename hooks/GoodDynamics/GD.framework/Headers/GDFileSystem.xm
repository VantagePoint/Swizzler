...
// }
+ (BOOL) getFileStat:(NSString*)filePath to:(id)filestat error:(NSError**) error
// + (BOOL) getFileStat:(NSString*)filePath to:(GDFileStat*)filestat error:(NSError**) error
{
    NSLog(@"GDFileSystem getFileStat: %@", filePath);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem removeItemAtPath: %@", filePath);
    return %orig;
}
...
+ (id) getReadStream:(NSString*)filePath error:(NSError**) error
// + (GDCReadStream*) getReadStream:(NSString*)filePath error:(NSError**) error
{
    NSLog(@"GDFileSystem getReadStream: %@", filePath);
    return %orig;
}
 ...
 */
+ (id) getWriteStream:(NSString*)filePath appendmode:(BOOL) flag error:(NSError**) error
// + (GDCWriteStream*) getWriteStream:(NSString*)filePath appendmode:(BOOL) flag error:(NSError**) error
{
    NSLog(@"GDFileSystem getWriteStream: %@", filePath);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem readFromFile: %@", name);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem writeToFile: %@, name: %@", data, name);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem writeToFile: %@, name: %@, fromOffset: %ld", data, name, (long)offset);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem createDirectoryAtPath: %@, withIntermediateDirectories: %d", path, createIntermediates);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem contentsOfDirectoryAtPath: %@", path);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem fileExistsAtPath: %@", path);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem moveItemAtPath: %@, toPath: %@", srcPath, dstPath);
    return %orig;
}
...
+ (BOOL) truncateFileAtPath:(NSString*)filePath
                   atOffset:(unsigned long long)offset
                      error:(NSError**) error
{
    NSLog(@"GDFileSystem truncateFileAtPath: %@, atOffset: %llu", filePath, offset);
    return %orig;
}
...
{
    NSLog(@"GDFileSystem getAbsoluteEncryptedPath: %@", filePath);
    return %orig;
}
