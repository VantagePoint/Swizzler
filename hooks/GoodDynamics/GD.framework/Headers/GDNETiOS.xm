...
{
    NSLog(@"GDDirectByteBuffer write: %s\n", data);
    %orig;
};
...
- (void)writeData:(NSData*)data
{
    ...
    NSLog(@"GDDirectByteBuffer writeData: %@", str);
    %orig;
};
...
{
    int ret = %orig;
    NSLog(@"GDDirectByteBuffer bytesUnread: %d", ret);
    return ret;
};
...
{
    int ret = %orig;
    NSLog(@"GDDirectByteBuffer read: %s\n", data);
    NSLog(@"            toMaxLength: %d", maxLength);
    return ret;
};
...
{
    NSLog(@"GDSocket init: %s, %d, %d", url, port, ssl);
    id ret = %orig;
    return ret;
};
...
{
    BOOL ret = %orig;
    NSLog(@"GDSocket disableHostVerification: %d", ret);
    return ret;
};
...
{
    BOOL ret = %orig;
    NSLog(@"GDSocket disablePeerVerification: %d", ret);
    return ret;
};
...
- (id)init
{
    DDLogVerbose(@"GDHttpRequest init");
    id ret = %orig;
...
{
    DDLogVerbose(@"GDHttpRequest open: %s, %s, isAsync:%d, %s, %s, %s", method, url, isAsync, user, password, auth);
...
{
    DDLogVerbose(@"GDHttpRequest open: %s, %s, %s, %s, %s", method, url, user, password, auth);
...
{
    DDLogVerbose(@"GDHttpRequest open: %s, %s, isAsync:%d", method, url, isAsync);
...
{
    DDLogVerbose(@"GDHttpRequest open: %s, %s", method, url);
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest disableHostVerification: %d", ret);
    return ret;
};
/**< Security option: Disable SSL/TLS host name verification.
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest disablePeerVerification: %d", ret);
    return ret;
};
/**< Security option: Disable SSL/TLS authenticity verification.
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest disableFollowLocation: %d", ret);
    return ret;
};
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest disableCookieHandling: %d", ret);
    return ret;
};
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest enableHttpProxy: %s, %d, %s, %s, %s", host, port, user, password, auth);
    return ret;
};
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest enableHttpProxy: %s. %d", host, port);
    return ret;
};
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest disableHttpProxy: %d", ret);
    ...
    if ([[plist objectForKey:@"settings_GDHttpRequest_proxy_enable"] boolValue])
    {
        ...
        DDLogVerbose(@"GDHttpRequest disableHttpProxy: original value %d, overwriting returning 0;", ret);
        DDLogVerbose(@"GDHttpRequest proxy being set to %s %d", ip, port);
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDHttpRequest setRequestHeader: %s, %s", header, value);
    return ret;
};
...
{
    DDLogVerbose(@"GDHttpRequest setPostValue: %s, %s", value, value);
    %orig;
};
...
{
    DDLogVerbose(@"GDHttpRequest send: %s, %d, %d", data, len, timeout_s);
    BOOL ret = %orig;
    return ret;
};
...
{
    DDLogVerbose(@"GDHttpRequest send: %s, %d", data, timeout_s);
    BOOL ret = %orig;
    return ret;
};
...
{
    DDLogVerbose(@"GDHttpRequest send: %s", data);
    BOOL ret = %orig;
    return ret;
};
...
- (BOOL) send
{
    DDLogVerbose(@"GDHttpRequest send");
    BOOL ret = %orig;
    return ret;
};
...
- (BOOL) sendData:(NSData*)data withTimeout:(int)timeout_s
{
    ...
    DDLogVerbose(@"GDHttpRequest sendData: %@, %d", string, timeout_s);
    BOOL ret = %orig;
    return ret;
};
...
{
    NSString *string = [[NSString alloc] initWithData:data encoding:NSUTF8StringEncoding];
    DDLogVerbose(@"GDHttpRequest sendData: %@", string);
    BOOL ret = %orig;
    return ret;
};
...
{
    const char *ret = %orig;
    DDLogVerbose(@"GDHttpRequest getAllResponseHeaders:%s", ret);
    return ret;
}
...
{
    int ret = %orig;
    DDLogVerbose(@"GDHttpRequest getStatus: %d", ret);

    DDLogVerbose(@"getAllResponseHeaders: %s", [self getAllResponseHeaders]);
...
%hook GDURLLoadingSystem

+ (void) enableSecureCommunication
{
    DDLogVerbose(@"GDURLLoadingSystem enableSecureCommunication");
    %orig;
};
...
{
    DDLogVerbose(@"GDURLLoadingSystem disableSecureCommunication");
    %orig;
};
...
{
    BOOL ret = %orig;
    DDLogVerbose(@"GDURLLoadingSystem isSecureCommunicationEnabled: %d", ret);
    return ret;
};
