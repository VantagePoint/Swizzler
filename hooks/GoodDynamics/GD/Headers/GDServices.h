 ...
 * -#  \link GDServiceClientDelegate::GDServiceClientDidReceiveFrom:withParams:withAttachments:correspondingToRequestID: GDServiceClientDidReceiveFrom\endlink once.
 * .
 */
 ...
 *              \link GDServiceClientDelegate::GDServiceClientDidReceiveFrom:withParams:withAttachments:correspondingToRequestID: GDServiceClientDidReceiveFrom\endlink invocation.
 *
 ...
 * of the application's \link GDService GDService\endlink instance.
 * 
 * This class also includes a callback that is invoked whenever transmission of
 ...
 *    GDServiceWillStartReceivingFrom:attachmentPath:fileSize:forRequestID:\endlink
 *    once for each file attachment.
 * -#  \link GDServiceDelegate::GDServiceDidReceiveFrom:forService:withVersion:forMethod:withParams:withAttachments:forRequestID: GDServiceDidReceiveFrom\endlink once.
 * .
 * 
 * \see   \link GDService GDService class reference\endlink for:
 ...
 *             be the same as one of the elements in the <TT>attachments</TT>
 *             parameter passed to the subsequent
 *              \link GDServiceDelegate::GDServiceDidReceiveFrom:forService:withVersion:forMethod:withParams:withAttachments:forRequestID: GDServiceDidReceiveFrom\endlink invocation.
 *
 * \param size <TT>NSNumber</TT> representing the size 
 *             of the file in bytes. The value will be an <TT>unsigned
 *             long long</TT>.
 ...
 * 
 * \see  \link GDFileManager\endlink for the secure fi<TT></TT>le system API
 *
