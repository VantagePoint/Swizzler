...
#define InstallHook_FindSymbol(funcname) if ([[plist objectForKey:@"settings_hookGD_"#funcname] boolValue]) { MSHookFunction(MSFindSymbol(NULL, "_"#funcname), (void *)replaced_##funcname, (void**)&orig_##funcname); }
