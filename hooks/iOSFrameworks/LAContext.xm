...
{
    NSLog(@"policy: %lld, localizedReason: %@, reply: %@", arg1, arg2, arg3);

    void(^newArg3)(BOOL success, NSError *error) = ^void (BOOL success, NSError *error)
    {
        arg3(1, NULL);
        NSLog(@"Ghost finger activated!");
    };
